...
public class EventService extends GitHubService {
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageEvents(String user, String repository) {
		return pageEvents(user, repository, PagedRequest.PAGE_SIZE);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageEvents(String user, String repository, final int size) {
		return pageEvents(user, repository, PagedRequest.PAGE_FIRST, size);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageEvents(String user, String repository, final int start,
			final int size) {
		PagedRequest<Event> request = createRepoEventRequest(user, repository, start, size);
		return createPageIterator(request);
	}
	 ...
	 * @return events page iterator
	 */
	public PageIterator<Event> pageNetworkEvents(String user, String repository) {
		return pageNetworkEvents(user, repository, PagedRequest.PAGE_SIZE);
	}
	...
	public PageIterator<Event> pageNetworkEvents(String user, String repository,
			final int size) {
		return pageNetworkEvents(user, repository, PagedRequest.PAGE_FIRST, size);
	}
	...
	public PageIterator<Event> pageNetworkEvents(String user, String repository,
		...
		PagedRequest<Event> request = createNetworkRepoEventRequest(user,
	 ...
	 * @return events page iterator
	 */
	protected PagedRequest<Event> createRepoEventRequest(String user,
	 ...
	 * @return events page iterator
	 */
	protected PagedRequest<Event> createNetworkRepoEventRequest(String user,
			String repository, int start, int size) {
