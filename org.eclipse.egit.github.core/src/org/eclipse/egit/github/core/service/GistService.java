...
public class GistService extends GitHubService {
	...
	protected PagedRequest<Gist> createUserGistRequest(String user,
		...
		PagedRequest<Gist> request = createPagedRequest(pageStart, pageSize);
	...
	public PageIterator<Gist> pageGists(String user, int size) {
		return pageGists(user, size, PagedRequest.PAGE_FIRST);
	}
	 ...
	 * @return gist page iterator
	 */
	public PageIterator<Gist> pageGists(String user, int size, int startPage) {
		PagedRequest<Gist> request = createUserGistRequest(user, startPage,
				size);
	...
	public PageIterator<Gist> pagePublicGists(int size) {
		return pagePublicGists(size, PagedRequest.PAGE_FIRST);
	}
	 ...
	 * @return gist page iterator
	 */
	public PageIterator<Gist> pagePublicGists(int size, int startPage) {
		PagedRequest<Gist> request = createPagedRequest(startPage, size);
		request.setUri(IGitHubConstants.SEGMENT_GISTS
