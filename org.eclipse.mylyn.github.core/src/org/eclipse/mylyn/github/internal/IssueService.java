...
/**
 * Issue service class for listing, searching, and fetching {@link Issue} objects using a
 * {@link GitHubClient}.
 * 
...
public class IssueService {
    ...
    public List<Issue> getIssues(String user, String repository,
        ...
        return this.client.get(builder.toString(), filterData, issueToken.getType());
    }
    ...
    public Issue createIssue(String user, String repository, Issue issue)
        ...
        uri.append(IGitHubConstants.SEGMENT_ISSUES).append(IGitHubConstants.SUFFIX_JSON);
    ...
    public Issue editIssue(String user, String repository, Issue issue)
        ...
        uri.append('/').append(issue.getNumber()).append(IGitHubConstants.SUFFIX_JSON);
     ...
     * @throws IOException
     */
    public Comment createComment(String user, String repository, String issueId,
