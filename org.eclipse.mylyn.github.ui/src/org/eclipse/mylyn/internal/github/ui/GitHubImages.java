...
public class GitHubImages {
	...
	public static final String GITHUB_LOGO_OBJ = NAME_PREFIX
			+ "OBJ_GITHUB_LOGO"; //$NON-NLS-1$

	/** Key for a GitHub issue label icon. */
	public static final String GITHUB_ISSUE_LABEL_OBJ = NAME_PREFIX
			+ "OBJ_GITHUB_ISSUE_LABEL"; //$NON-NLS-1$

	/** Key for an "add" icon. */
	public static final String GITHUB_ADD_OBJ = NAME_PREFIX + "GITHUB_ADD_OBJ"; //$NON-NLS-1$

	/** Key for a "check all" icon. */
	public static final String GITHUB_CHECKALL_OBJ = NAME_PREFIX
			+ "GITHUB_CHECKALL_OBJ"; //$NON-NLS-1$

	/** Key for an "uncheck all" icon. */
	public static final String GITHUB_UNCHECKALL_OBJ = NAME_PREFIX
			+ "GITHUB_UNCHECKALL_OBJ"; //$NON-NLS-1$
	...
	public static final ImageDescriptor DESC_GITHUB_LOGO = create(PATH_OBJ,
			"github.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for the GitHub issue label icon. */
	public static final ImageDescriptor DESC_GITHUB_ISSUE_LABEL = create(
			PATH_OBJ, "issue_label.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for the "add" icon. */
	public static final ImageDescriptor DESC_GITHUB_ADD = create(PATH_OBJ,
			"add.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for the "check all" icon. */
	public static final ImageDescriptor DESC_GITHUB_CHECKALL = create(PATH_OBJ,
			"check_all.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for the "uncheck all" icon. */
	public static final ImageDescriptor DESC_GITHUB_UNCHECKALL = create(
			PATH_OBJ, "uncheck_all.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for the organization icon. */
	public static final ImageDescriptor DESC_GITHUB_ORG = create(PATH_OBJ,
			"org.png"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for a person icon. */
	public static final ImageDescriptor DESC_PERSON = create(PATH_TOOL,
			"person.gif"); //$NON-NLS-1$

	/** {@link ImageDescriptor} for a person icon denoting the current user. */
	public static final ImageDescriptor DESC_PERSON_ME = create(PATH_TOOL,
			"person-me.gif"); //$NON-NLS-1$
