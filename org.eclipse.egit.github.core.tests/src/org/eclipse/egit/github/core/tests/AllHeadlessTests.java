 ...
 */
@RunWith(Suite.class)
@SuiteClasses({ ApplicationTest.class, AuthorizationTest.class, BlobTest.class,
		CollaboratorServiceTest.class, CommentTest.class,
		CommitCommentTest.class, CommitFileTest.class, CommitServiceTest.class,
		CommitTest.class, CommitUserTest.class, ContributorTest.class,
		...
		GsonUtilsTest.class, IdTest.class, IssueEventTest.class,
		...
		MilestoneTest.class, OAuthServiceTest.class,
		OrganizationServiceTest.class, PagedRequestTest.class,
		PullRequestMarkerTest.class, PullRequestServiceTest.class,
		PullRequestTest.class, ReferenceTest.class, RepositoryBranchTest.class,
