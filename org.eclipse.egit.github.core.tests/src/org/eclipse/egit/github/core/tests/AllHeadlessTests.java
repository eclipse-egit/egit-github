...
@SuiteClasses({ BlobTest.class, CollaboratorServiceTest.class,
		...
		DownloadResourceTest.class, EncodingUtilsTest.class, EventPayloadTest.class,
		EventServiceTest.class, EventTest.class,
		...
		GitHubClientTest.class, GollumPageTest.class, GsonUtilsTest.class, IdTest.class,
